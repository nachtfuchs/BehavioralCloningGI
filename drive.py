...
from model import image_wrapper
...
def telemetry(sid, data):
    if data:
        ...
        image_array = np.asarray(image)#add image size preprocessing here #debug
        transformed_image_array = image_array[None, :, :, :]
        preprocessed  = image_wrapper(transformed_image_array[0]) # preprocessing
...
def send_control(steering_angle, throttle):
    print('Sending data')
    print('Steering angle: %.2f' % steering_angle)
